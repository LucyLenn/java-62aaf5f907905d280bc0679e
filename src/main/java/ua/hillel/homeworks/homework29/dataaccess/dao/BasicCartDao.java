...
@Repository
public class BasicCartDao implements CartDaoService {
    ...
    private static final String FIND_BY_ID_QUERY =
            "SELECT cart_id, product_id, products.name as p_name, products.price as p_price " +
                    ...
                    "WHERE cart_id = ?";
    private static final String INSERT_QUERY = "INSERT INTO carts DEFAULT VALUES";
    private static final String DELETE_QUERY = "DELETE FROM carts WHERE id = ?";

    private final JdbcTemplate jdbcTemplate;

    public BasicCartDao(DataSource dataSource) {
